        ...
        <section ref={contactRef} className="py-20 px-4 bg-white text-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-6 mb-2">
              <a href="https://github.com/MaikeruDev" className="text-3xl hover:text-gray-700 transition-colors" aria-label="GitHub Profile"><FaGithub /></a>
              <a href="https://www.linkedin.com/in/michael-prietl-93a6b625b/" className="text-3xl hover:text-gray-700 transition-colors" aria-label="LinkedIn Profile"><FaLinkedin /></a>
              <a href="mailto:michael@prietl.com" className="text-3xl hover:text-gray-700 transition-colors" aria-label="Email Contact"><FaEnvelope /></a>
            </div>
          </div>
        </section>
      </main>
